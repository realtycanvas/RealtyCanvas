      ...
      return (
        (e.toggle = function () {
          ...
          this._element.hasAttribute('disabled') ||
            ...
            (e && this._element.setAttribute('aria-pressed', !this._element.classList.contains(m)),
    ...
    .on('click.bs.button.data-api', g, function (t) {
      ...
      if (
        ...
        ('INPUT' !== n.tagName && 'LABEL' === e.tagName) ||
          b._jQueryInterface.call(i.default(e), 'toggle', 'INPUT' === n.tagName);
      }
    })
            ...
            if ((i.default(this._element).trigger(e), !e.isDefaultPrevented())) {
              ...
              if (o > 0)
                for (var r = 0; r < o; r++) {
                  ...
                  null !== s &&
                    (i.default([].slice.call(document.querySelectorAll(s))).hasClass(P) ||
  ...
  function Dt(t, e, n) {
    return (
      (void 0 === n
        ...
        t.enabled &&
          z(n) &&
          ((e.offsets.popper = ht(e.offsets.popper)), (e.offsets.reference = ht(e.offsets.reference)), (e = n(e, t)));
      }),
      e
    );
  }
  ...
  function Mt(t, e, n) {
    ...
    if (!o) {
      var r = '`' + e + '`',
        a = '`' + n + '`';
      console.warn(
        a + ' modifier is required by ' + r + ' modifier in order to work, be sure to include it before ' + r + '!'
      );
    }
    return o;
  }
      ...
      modifiers: {
        ...
        arrow: {
          ...
          fn: function (t, e) {
            ...
            return (
              ...
              (t.arrowElement = i),
              (t.offsets.arrow = (dt((n = {}), d, Math.round(b)), dt(n, c, ''), n)),
              t
            );
          },
          element: '[x-arrow]',
        ...
        computeStyle: {
          ...
          fn: function (t, e) {
            ...
            if (
              ((s =
                'bottom' === h ? ('HTML' === u.nodeName ? -u.clientHeight + c.bottom : -f.height + c.bottom) : c.top),
      ...
      return (
        ...
        (t._jQueryInterface = function (e) {
          return this.each(function () {
            ...
            if (
              (n || ((n = new t(this, 'object' == typeof e ? e : null)), i.default(this).data(Kt, n)),
              'string' == typeof e)
            ) {
        ...
        (t._dataApiKeydownHandler = function (e) {
          if (
            !(/input|textarea/i.test(e.target.tagName)
              ? 32 === e.which ||
                (27 !== e.which && ((40 !== e.which && 38 !== e.which) || i.default(e.target).closest(re).length))
              : !Gt.test(e.which)) &&
            !this.disabled &&
            ...
            if (o || 27 !== e.which) {
              if ((e.preventDefault(), e.stopPropagation(), !o || 27 === e.which || 32 === e.which))
                return (
                  27 === e.which && i.default(n.querySelector(oe)).trigger('focus'),
        ...
        (o._jQueryInterface = function (t) {
          return this.each(function () {
            ...
            if (
              ...
              (e || ((e = new o(this, n)), i.default(this).data(Ye, e)), 'string' == typeof t)
            ) {
      ...
      return (
        ...
        (t._jQueryInterface = function (e) {
          return this.each(function () {
            ...
            if (
              (n || ((n = new t(this, 'object' == typeof e && e)), i.default(this).data(tn, n)), 'string' == typeof e)
            ) {
              if ('undefined' == typeof n[e]) throw new TypeError('No method named "' + e + '"');
              n[e]();
            }
    ...
    gn = (function () {
      ...
      return (
        ...
        (e._activate = function (t, e, n) {
          var o = this,
            r = (
              !e || ('UL' !== e.nodeName && 'OL' !== e.nodeName) ? i.default(e).children(pn) : i.default(e).find(mn)
            )[0],
