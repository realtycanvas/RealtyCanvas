  ...
  return (
    <html lang="en">
      <head>
        ...
        {/* Google Analytics */}
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-WQY624K8FC"></script>
        <script
          dangerouslySetInnerHTML={{
            __html: `
      ...
      >
        <noscript>
          <img
            ...
            width="1"
            style={{ display: 'none' }}
            src="https://www.facebook.com/tr?id=1131930585484960&ev=PageView&noscript=1"
            alt=""
          />
        </noscript>
        <SpeedInsights />
