export const REAL_ESTATE_TOPICS = [
  ...
  'property management',
  'RealtyCanvas platform features',
  'property valuation',
...
export const SYSTEM_PROMPT = `You are RealtyCanvas Assistant, a helpful AI chatbot for a premium real estate platform called "RealtyCanvas". 
...
- Suggest contacting RealtyCanvas experts for complex legal/financial advice
- Mention relevant RealtyCanvas features when appropriate
...
- "How can I list my property on RealtyCanvas?"`;
...
export function isRealEstateRelated(message: string): boolean {
  const realEstateKeywords = [
    ...
    'RealtyCanvas', 'platform', 'listing', 'search', 'filter',
