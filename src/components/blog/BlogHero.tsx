...
export default function BlogHero() {
  return (
    <section className="relative mt-24 overflow-hidden bg-gradient-to-br from-secondary-500 via-secondary-600 to-secondary-700 dark:from-secondary-800 dark:via-secondary-900 dark:to-black">
      {/* Background Pattern */}
