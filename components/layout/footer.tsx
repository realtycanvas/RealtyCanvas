            ...
            <div className=" pt-8 ">
              <div className="grid grid-cols-1 -mt-8 gap-6">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <a href="tel:+919555562626" className="text-gray-300 hover:text-white transition-colors">
                      +91 9555562626
                    </a>
                  </div>
                </div>
          ...
          <div className="border-t border-gray-700 py-8">
            <div className="flex flex-wrap gap-2">
              {[
                ...
                {
                  label: 'Smartworld Trump Residences',
                  href: '/projects/smartworld-the-trump-residences-sector-69-gurgaon',
                },
